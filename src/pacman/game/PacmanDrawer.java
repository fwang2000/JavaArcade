...
import pacman.domain.Dot;
import pacman.domain.Fruit;
import pacman.domain.Ghost;
import pacman.domain.Wall;
...
public class PacmanDrawer extends JPanel implements Updatable {
    ...
    public void paintWalls(Graphics g) {
        ...
        for (Wall wall : game.getWalls()) {
            ...
            int wallLength = wall.getWallX() * sideLength;
            int wallHeight = wall.getWallY() * sideLength;
