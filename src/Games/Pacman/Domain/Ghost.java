...
import Games.Pacman.Domain.Pacman;
...
public class Ghost extends Piece implements ActionListener {
    ...
    public boolean equals(Object compared) {
        ...
        if (this.x != ((Ghost) compared).getGhostX() || this.y != ((Ghost) compared).getGhostY()) {
    ...
    public boolean ghostPathBlocked() {
        ...
        if (getDirection() == Direction.UP) {
            ...
            return walls.contains(new Wall(x, y - 1));
            ...
            return walls.contains(new Wall(x - 1, y));
    ...
    public void pathClearDirectionIsHorizontal(List<Direction> possibleDirections) {
        ...
        if (!walls.contains(new Wall(x, y - 1))) {
    ...
    public void pathClearDirectionIsVertical(List<Direction> possibleDirections) {
        ...
        if (!walls.contains(new Wall(x + 1, y))) {

            possibleDirections.add(Direction.RIGHT);
        }
        if (!walls.contains(new Wall(x - 1, y + 1))) {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (y == 6 && x > 16 && x < 22 && game.getContinues()) {
